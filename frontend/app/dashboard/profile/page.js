            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full rounded-lg border border-slate-300 px-4 py-3 focus:border-lime-600 focus:outline-none focus:ring-2 focus:ring-lime-600/20 disabled:bg-slate-50 disabled:text-slate-500"
                />
              </div>
            ...
            {isEditing && (
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 rounded-full bg-lime-600 px-6 py-3 text-sm font-semibold text-white hover:bg-lime-700 disabled:opacity-50 transition-colors"
                >
